...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$insert = "insert into users (f_name,l_name,user_name,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,status,posts)
		values('$first_name','$last_name','$username','$pass','$email','$country','$gender','$birthday','default_user.png','default_cover.jpg',NOW(),'$status','$posts')";
